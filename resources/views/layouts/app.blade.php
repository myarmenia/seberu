  ...
  <header>
    ...
    <div id="cont" class="container d-flex">
      ...
      <div class="filter-div">
        ...
        <div class="fnc">
          <div class="icns icon"><img src="{{asset('storage/main-images/orders.png')}}" style="height: 25px;margin-top: 5px;"><br />Заказы</div>
          <div class="icns icon"><i class="fa fa-shopping-basket" style="font-size: 25px;color: grey;margin-top: 3px;"></i><br />Корзина</div>
          <div class="icns icon">
            @if(Auth::check())
